...
function AppContent() {
  ...
  const [theme, setTheme] = useState(() => {
    ...
    const stored =
      localStorage.getItem('confiSitTheme');
  ...
  const handleLogin = (credentials) => {
    ...
    /*
     * Si credentials.id est valide,
     * on l'utilise.
     *
     * Sinon on garde éventuellement
     * l'ID déjà présent dans le compte local.
     */

    const validBackendId =
      Number.isInteger(backendId) &&
      backendId > 0;


    const existingId =
      Number(existingAccount?.id);
    ...
    const nextUser = {
       ...
       */
      childrenCount:
        credentials?.childrenCount ||
        existingAccount?.childrenCount ||
        1,
      ...
      hourlyRate:
        credentials?.hourlyRate ||
        existingAccount?.hourlyRate ||
        35,

      zone:
        credentials?.zone ||
        existingAccount?.zone ||
        'Tunis',

      availability:
        credentials?.availability ||
        existingAccount?.availability ||
        ['Matin'],

      experience:
        credentials?.experience ||
        existingAccount?.experience ||
        3,
      ...
      <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-amber-200 selection:text-slate-900 dark:bg-slate-950 dark:text-slate-100 dark:selection:bg-amber-500/30">
        ...
        <main className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
          ...
          <Routes>
                ...
                <div className="mx-auto max-w-2xl rounded-3xl bg-white p-9 shadow-[0_25px_70px_rgba(15,23,42,0.08)] dark:bg-slate-900 dark:shadow-[0_25px_70px_rgba(0,0,0,0.3)]">
                  ...
                  <form className="mt-8 grid gap-6">
                    ...
                    <input
                      ...
                      className="w-full rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-slate-700 outline-none transition-all duration-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:focus:ring-orange-500/30"
                    />

                    <button
                      type="button"
                      className="w-full rounded-full bg-gradient-to-r from-orange-600 to-amber-600 px-8 py-4.5 text-base font-semibold text-white shadow-[0_20px_50px_rgba(249,115,22,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_25px_60px_rgba(249,115,22,0.35)] focus:outline-none focus:ring-2 focus:ring-orange-400 sm:w-auto"
                    >
                      {t(
              ...
              <Route
                ...
                element={
                  <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <h2 className="mt-3 text-2xl font-extrabold text-slate-900 dark:text-slate-100">
                      Gérez les utilisateurs et leurs profils
                    </h2>
              ...
              <Route
                ...
                element={
                  <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <h2 className="mt-3 text-2xl font-extrabold text-slate-900 dark:text-slate-100">
                      Traitez les signalements du support
                    </h2>
            ...
            <Route
              path="/espace-babysitter"
              element={
                <PrivateRoute requiredRole="babysitter">
                  <BabysitterDashboardPage user={user} />
                </PrivateRoute>
              }
            >
              ...
              <Route
                ...
                element={
                  <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <h2 className="mt-3 text-2xl font-extrabold text-slate-900 dark:text-slate-100">
                      Bienvenue dans votre espace babysitter
                    </h2>
