  ...
  if (!sitter) {
    return (
      <div className="rounded-3xl bg-white p-12 shadow-[0_25px_70px_rgba(15,23,42,0.08)] text-center dark:bg-slate-900 dark:shadow-[0_25px_70px_rgba(0,0,0,0.3)]">
        <p className="text-lg font-extrabold text-slate-900 dark:text-slate-100">{t('sitterProfile.notFound.title')}</p>
        <Link to="/recherche" className="mt-7 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 px-7 py-3.5 text-sm font-semibold text-white shadow-[0_15px_40px_rgba(249,115,22,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(249,115,22,0.35)]">
          <ArrowLeft size={18} /> {t('sitterProfile.notFound.cta')}
        </Link>
      </div>
    );
  }
    ...
    <section className="space-y-12 py-16 lg:py-24">
      <div className="flex flex-col gap-8 rounded-3xl bg-gradient-to-br from-white to-amber-50 p-9 shadow-[0_25px_70px_rgba(249,115,22,0.08)] lg:flex-row lg:items-center lg:justify-between dark:from-slate-900 dark:to-amber-900/20 dark:shadow-[0_25px_70px_rgba(0,0,0,0.3)]">
        <div>
          <Link to="/recherche" className="inline-flex items-center gap-2 text-sm font-extrabold text-amber-600 transition-all duration-300 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-300">
            <ArrowLeft size={20} /> {t('sitterProfile.backToSearch')}
          </Link>
          <div className="mt-7 flex flex-col gap-5 sm:flex-row sm:items-center">
            ...
            <div className="space-y-5">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <span className="rounded-full bg-gradient-to-r from-amber-100 to-orange-100 px-5 py-2.5 text-sm font-extrabold text-amber-700 dark:from-amber-900/30 dark:to-orange-900/30 dark:text-amber-300">{t('sitterProfile.rating', { rating: sitter.rating.toFixed(1) })}</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 text-sm text-slate-600 dark:text-slate-400">
                ...
                <span className="inline-flex items-center gap-2 rounded-full bg-slate-100 px-5 py-3 shadow-sm dark:bg-slate-800"><Clock3 size={18} /> {t('search.sitterCard.experience', { experience: sitter.experience })}</span>
                <span className="inline-flex items-center gap-2 rounded-full bg-slate-100 px-5 py-3 shadow-sm dark:bg-slate-800"><DollarSign size={18} /> {t('search.sitterCard.rate', { rate: sitter.rate })}</span>
              </div>
            </div>
          </div>
        </div>
        <div className="rounded-3xl bg-white p-7 text-slate-700 shadow-[0_20px_60px_rgba(15,23,42,0.05)] dark:bg-slate-900 dark:text-slate-200 dark:shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
          <p className="text-sm font-extrabold uppercase tracking-[0.32em] text-amber-600 dark:text-amber-400">{t('sitterProfile.availability')}</p>
          ...
          <button className="mt-7 w-full rounded-full bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4 text-sm font-semibold text-white shadow-[0_15px_40px_rgba(249,115,22,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(249,115,22,0.35)]">{t('sitterProfile.contact')}</button>
        </div>
      </div>
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_380px]">
        <div className="space-y-10 rounded-3xl bg-white p-9 shadow-[0_25px_70px_rgba(15,23,42,0.08)] dark:bg-slate-900 dark:shadow-[0_25px_70px_rgba(0,0,0,0.3)]">
          <div className="space-y-5">
            <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">{t('sitterProfile.about')}</h2>
            <p className="text-lg text-slate-600 dark:text-slate-300">{sitter.bio}</p>
          </div>
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-amber-50 p-7 dark:from-slate-800 dark:to-amber-900/20">
              <p className="text-sm font-extrabold text-slate-500 dark:text-slate-400">{t('sitterProfile.languages')}</p>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-amber-50 p-7 dark:from-slate-800 dark:to-amber-900/20">
              <p className="text-sm font-extrabold text-slate-500 dark:text-slate-400">{t('sitterProfile.services')}</p>
          ...
          <div className="space-y-5">
            <h3 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">{t('sitterProfile.reviewsTitle')}</h3>
            <div className="space-y-5">
        ...
        <aside className="space-y-8 rounded-3xl bg-white p-9 shadow-[0_25px_70px_rgba(15,23,42,0.08)] dark:bg-slate-900 dark:shadow-[0_25px_70px_rgba(0,0,0,0.3)]">
          <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-amber-50 p-7 dark:from-slate-800 dark:to-amber-900/20">
            <div className="flex items-center gap-3 text-slate-700 dark:text-slate-200">
              ...
              <span className="font-extrabold">{t('sitterProfile.booking.title')}</span>
            </div>
            <p className="mt-5 text-sm text-slate-600 dark:text-slate-400">{t('sitterProfile.booking.description')}</p>
          </div>
          <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-amber-50 p-7 dark:from-slate-800 dark:to-amber-900/20">
            <div className="flex items-center gap-3 text-slate-700 dark:text-slate-200">
              <MessageSquare size={22} />
              <span className="font-extrabold">{t('sitterProfile.faq.title')}</span>
            </div>
            <ul className="mt-5 space-y-4 text-sm text-slate-600 dark:text-slate-400">
              <li className="font-medium">{t('sitterProfile.faq.q1')}</li>
              <li className="font-medium">{t('sitterProfile.faq.q2')}</li>
              <li className="font-medium">{t('sitterProfile.faq.q3')}</li>
            </ul>
          </div>
        </aside>
      </div>
